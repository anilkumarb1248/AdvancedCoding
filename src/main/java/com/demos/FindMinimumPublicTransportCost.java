 ...
 *  A[6] = 30
 *
 * You can buy one 7-day ticket and two 1-day tickets. The two 1-day tickets should be used
 * on days 29 and 30. The 7-day ticket should be used on the first seven days of the month.
...
public class FindMinimumPublicTransportCost {

    public static void main(String args[]){
        FindMinimumPublicTransportCost obj = new FindMinimumPublicTransportCost();
        obj.printStatements();
    ...
    public void printStatements(){
        ...
        System.out.println("1,2,4,5,7,29,30" + " : "+ this.solution(a1));
    }
    ...
    public int solution(int[] a){
        ...
        for(int firstIndex = 0; firstIndex < a.length; firstIndex++){
            ...
            if(counter + a[firstIndex] > 7){

            }
            counter = counter + a[firstIndex];
